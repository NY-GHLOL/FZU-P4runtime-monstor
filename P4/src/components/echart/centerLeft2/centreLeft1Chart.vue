<template>
  <div>
    <div id="centreLeft1Chart" style="width:11rem; height: 5rem;"></div>
  </div>
</template>
...
let dataList = [{
    name: 'h1-h2',
    value: this.jsonData[1]["bandwidth"]
}, {
    name: 'h2-h1',
    value: this.jsonData[3]["bandwidth"]
}, {
    name: 'h2-h3',
    value: this.jsonData[5]["bandwidth"]
}, {
    name: 'h3-h2',
    value: this.jsonData[7]["bandwidth"]
}, {
    name: 'h1-h3',
    value: this.jsonData[9]["bandwidth"]
}, {
    name: 'h3-h1',
    value: this.jsonData[11]["bandwidth"]
}];
let dataList2 = [{
    name: 'h1-h2',
    value: this.jsonData[1]["transfer"]
}, {
    name: 'h2-h1',
    value: this.jsonData[3]["transfer"]
}, {
    name: 'h2-h3',
    value: this.jsonData[5]["transfer"]
}, {
    name: 'h3-h2',
    value: this.jsonData[7]["transfer"]
}, {
    name: 'h1-h3',
    value: this.jsonData[9]["transfer"]
}, {
    name: 'h3-h1',
    value: this.jsonData[11]["transfer"]
}];
var img = [
...
var datacoords = [{
    coords: [
        ['h1-h2', this.jsonData[1]["bandwidth"]],
        ['h2-h1', this.jsonData[3]["bandwidth"]],
        ['h2-h3', this.jsonData[5]["bandwidth"]],
        ['h3-h2', this.jsonData[7]["bandwidth"]],
        ['h1-h3', this.jsonData[9]["bandwidth"]],
        ['h3-h1', this.jsonData[11]["bandwidth"]],
    ]
}]
this.chart.setOption({
  backgroundColor: null,
    ...
    xAxis: [{
        type: "category",
        data: ['h1-h2', 'h2-h1', 'h2-h3', 'h3-h2', 'h1-h3', 'h3-h1'],
        axisLabel: {
            textStyle: {
                color: "#ffffff",
                fontSize: 16,
